...
$query ="SELECT
zonas.rango_inicial_planillas,
zonas.rango_final_planillas,
zonas.id_zona,
zonas.zona
FROM
zonas
	...
	<?
           ...
           <div class="container"> 
		     <p></p><p></p>
			   <div align="center">
				   <? 
	//echo $zonass.$aux_id_get1.$conteo_de_zona.$aux_id_get1.$la_de_conteo;
	
	?>
			   <a href="detalle_planilla_excel.php?id_planilla=<?echo $zonass.$aux_id_get1.$conteo_de_zona.$aux_id_get1.$la_de_conteo?>"><img src="images/icono_excel.jpg" width="57" height="57" alt=""/></a></div>
...
<tr>
<td><? echo $zona;?></td>	
<td><a href="conteos_zonas.php?id=<?=$id_zona ?>" target="_blank"><? echo $i;?></a></td>
<td><? echo $Barra;?></td>
<td><a href="detalle_planilla.php?id_planilla=<?=$i.$aux_id_get1.$id_zona.$aux_id_get1."1"?>" target="_blank"><? echo $Cont1;?></a></td>
<td><a href="detalle_planilla.php?id_planilla=<?=$i.$aux_id_get1.$id_zona.$aux_id_get1."2"?>" target="_blank"><? echo $Cont2;?></a></td><td><? echo $dah;?></td>
