...
/////////////////////////////////////////////////	
  ...
  if (empty($busqueda)){
	  ...
	  $sql = "SELECT descripcion FROM cat_productos WHERE barras = $busqueda";
...
<table width="60%" border="0" align="center">
  <tbody>
    <tr>
		...
		if ($conteo == 3) {
		?>
      <th scope="col"><a href="planillas_c3.php?id=<? echo $m_zona;?>" class="myButton">CAMBIAR</a>
		  <? }else{ ?>
<th scope="col"><a href="planillas.php?id=<? echo $m_zona;?>" class="myButton">CAMBIAR</a>
	<? } ?>
<style>
.myButton {
...
<form action="cierre_planilla.php" method="post" id="cierre" onsubmit="return alerta();" >
	...
	<input name="cierre_planilla" type="hidden" id="cierre_planilla" value="<?=$planilla?>">

	<a href="#" class="myButton" onClick='alerta();'>CERRAR</a>
