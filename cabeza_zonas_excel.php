                ...
                <table width="44%" border="2" align="center" cellpadding="{scmCellpadding}" cellspacing="0" id="sites-chrome-main">
                  <tbody>
                    <tr>
                      ...
                      <td id="sites-canvas-wrapper" style="text-align: center" bgcolor="#56CBAF"><strong> Conteo1</strong></td>
                      <td id="sites-canvas-wrapper" style="text-align: center" bgcolor="#56CBAF"><strong> Conteo2</strong></td>
                    ...
                    <tr>
                      <td width="10%" bgcolor="#56CBAF" id="sites-canvas-wrapper"><h1><?
...
else
{
 ...
 while ($row = odbc_fetch_object($resultqa))
	...
	echo $jp;
						  ...
						  ?></h1></td>
                      <td width="5%" bgcolor="#56CBAF" id="sites-canvas-wrapper5" style="text-align: center">
						  <h1><?
						$sql2ac = "
						SELECT
...
while($fila2ac = mysql_fetch_assoc($resultado2ac)){ 
              $maxac = $fila2ac['jp'];
						  ...
						  echo $t2c."";	  
						  ?></h1></td>
                      <td width="5%" bgcolor="#56CBAF" id="sites-canvas-wrapper5" style="text-align: center"><h1>
                        <?
						$sql2ac = "
						SELECT
...
while($fila2ac = mysql_fetch_assoc($resultado2ac)){ 
              $maxac = $fila2ac['jp'];
						  ...
						  ?>
                      <td width="5%" bgcolor="#56CBAF" id="sites-canvas-wrapper5" style="text-align: center"><h1><? echo ($con3); ?></h1></td>
                      <td width="5%" bgcolor="#56CBAF" id="sites-canvas-wrapper5" style="text-align: center">
						  <h1><?
						$sql2a = "
						SELECT
