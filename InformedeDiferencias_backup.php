...
{     
echo "<br> Planilla " . $i . ": " . $provincia[$i];    }
...
.navbar2 {	font-family: 'Dosis', sans-serif;
	...
	<?
		...
		<li class="drpcontent"><a href="zonas.php"><i class="icon20 comments"></i><span>Zonas</span></a>
		
	</li>	  
 <li class="drpdown"><a href="#"><i class="icon20 comments"></i><span>Administracion</span></a>
		<ul class="drpcontent">
			<li><a href="avanceporhora.php" target="_blank">Avance Por Hora</a></li>
			<li><a href="InformedeDiferencias.php" target="_blank">Informe de Diferencias</a></li>
			<li><a href="LimpiarPlanilla.php" target="_blank">Limpiar Planilla</a></li>
			<li><a href="RecuperarPlanilla.php" target="_blank">Recuperar Planilla</a></li>

			<li><a href="conteos_excel.php" target="_blank">Todos los Conteos</a></li>
		</ul>
	</li>
		<li class="drpcontent"><a href="index.php"><i class="icon20 comments"></i><span>Salir</span></a>
	...
	<?
      ...
      <table width="20%" border="0" align="center">
            <tbody>
              <tr>
                <th scope="col"><label for="zonas">Zonas:</label>
                <input name="zonas" type="number" autofocus id="zonas" size="5" maxlength="5"></th>
                <th scope="col"><span style="text-align: center">
                <input name="Input" onClick="return validaFecha( this.form );" type="image" src="images/btn_ver.png">
                </span></th>
              </tr>
            </tbody>
      </table>
	 ...
	 <div class="container">
             <div class="table-responsive"> 
				 <form method="post">
      <table width="60%" align="center" class="table table-striped table-bordered" id="employee_data">  
      <thead>  
        <tr>
          <th style="text-align: center" scope="col">Zona</th>
		  <th style="text-align: center" scope="col">Planilla</th>
			<th style="text-align: center" scope="col">Conteo Anterior</th>
			<th style="text-align: center" scope="col">Conteo 1</th>
			<th style="text-align: center" scope="col">Conteo 2		  </th>
            <th style="text-align: center" scope="col">Diferencia</th>
		    <th style="text-align: center" scope="col">Inc.</th>
		</tr>
        </thead>  
     <? 
...
fi_conteos.Planilla,
zonas.zona,
fi_conteos.Zona zzona
FROM
fi_conteos ,
zonas
WHERE
fi_conteos.Zona = zonas.id_zona and zonas.zona = $zonass and hconteo3 = 0 and Estado = 2
order by 1";  
...
Sum(fi_conteos.Cantidad) c1
FROM
fi_conteos
where Conteo = 3 and planilla = $Planilla and Zona = $idzona and Estado = 2";  
...
FROM
fi_conteos
where Conteo = 1 and planilla = $Planilla and Zona = $idzona and Estado = 2";  
$result2 = mysqli_query($connect, $query2);
while($row2 = mysqli_fetch_array($result2)) 
	{	
$c1b=$row2["c1"];
...
Sum(fi_conteos.Cantidad) c2
FROM
fi_conteos
where Conteo = 2 and planilla = $Planilla and Zona = $idzona and Estado = 2";  
...
if ($dah==1)
	{
		$resa1dah = $mysqli->query("delete from fi_conteos WHERE Planilla = $Planilla and zona = $idzona and Bodega = $num_tienda and conteo = 1 and Estado = 2");	
		$resa1zdah = $mysqli->query("UPDATE fi_conteos SET conteo = 1  WHERE  Planilla = $Planilla and zona = $idzona and Bodega = $num_tienda and conteo = 3 and Estado = 2"); 	
	}	
$resa1z = $mysqli->query("UPDATE fi_conteos SET hconteo3 = 1  WHERE  planilla = $Planilla and zona = $idzona and Bodega = $num_tienda and Estado = 2"); 	
$resa1 = $mysqli->query("delete from planilla_c3 WHERE 	planilla = $Planilla and zona = $zona and tienda = $num_tienda and Estado = 2");	
	
}//echo '<td >OK<img src=images/check_verde.png width=35/></td>';  	 
else {
$query3z ="SELECT * FROM planilla_c3 WHERE planilla = $Planilla and zona = $zona";  
 $result3z = mysqli_query($connect, $query3z);
while($row3z = mysqli_fetch_array($result3z)){	
$c2z=$row3z["planilla"];	
}
if (empty($c2z)) {
$resa = $mysqli->query("INSERT INTO planilla_c3 (planilla, zona,tienda) VALUES ($Planilla, $zona,$num_tienda)"); 
}else {
$query3zjp ="SELECT * FROM fi_conteos WHERE Planilla = $Planilla and Zona = $idzona and conteo = 3 and Estado = 2
";  
...
$resa1 = $mysqli->query("UPDATE fi_conteos SET Conteo = 4  WHERE Conteo = 1 and planilla = $Planilla and zona = $idzona and Bodega = $num_tienda and Estado = 2"); 

$resa1 = $mysqli->query("UPDATE fi_conteos SET Conteo = 1  WHERE Conteo = 3 and planilla = $Planilla and zona = $idzona and Bodega = $num_tienda and Estado = 2"); 	
	}
}
...
$c2=$row3["c2"];
	...
	$query3n ="SELECT DISTINCT
Sum(fi_conteos.Cantidad) c3
FROM
fi_conteos
where Conteo = 4 and planilla = $Planilla and Zona = $idzona and Estado = 2
";  
 $result3b = mysqli_query($connect, $query3n);
...
//////////////////////////////////////////
echo '<td style=text-align: center><h4>'.$zona.'</h4></td>';
echo '<td style=text-align: center>'.$Planilla.'</td>';
//////////////////////////////////////////			  
echo '<td >'.$c3.'</font></h4></td>';
echo '<td >'.$c1.'</font></h4></td>';
echo '<td >'.$c2.'</font></h4></td>';
echo '<td >'.$tot.'</font></h4></td>'; 
////////////////////////////////////IMPRIMO TD
	echo '<td >DIF<img src=images/check_rojo.png width=35/></td>';	
}
}
		  $c1='';
		  $c2='';
