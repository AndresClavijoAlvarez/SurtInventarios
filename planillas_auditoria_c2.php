...
.navbar > li:hover .icon20.login {background-position:-100px -20px;}
	...
	*/?>
           ...
           <table width="70%" border="10" align="center">
             <tbody>
               <tr>
                 <th colspan="2" scope="col" align="center"><div align="center">Mis planillas - Auditoria</div></th>
               </tr>
               <tr class="btn-danger">
...
$nombre_zona = 	$row['zona'];
					 ...
					 $queryqa ="SELECT Planilla FROM fi_conteos_manual where Planilla = $i and Bodega = $num_tienda and estado =2 and conteo = $conteo_de_zona"; 
					 
$resultqa = mysqli_query($connect, $queryqa); 
if (mysqli_num_rows($resultqa)> 0){
					 $jp=1;?>
	<a target="_blank" href="detalle_planilla_c2.php?id_planilla=<?=$i.$aux_id_get1.$id_zonas.$aux_id_get1.$conteo_de_zona?>"><span class="button"><p><?=$i?></p></span></a>
<?php 
}
 }  
	if ($jp == 0){echo "Sin Datos";}
?> 	
</div></td>
		  <?php 
	  ...
	  ?>
               ...
               <tr class="btn-danger">
                 ...
                 <th width="50%" style="text-align: center" scope="col">Pendientes</th>
               </tr>
               <tr>
				    <td>
 	<?php 
