...
// falta      where planilla =1 and zona =1 and tienda = 313
$query3zq ="SELECT * FROM planilla_c3 WHERE Planilla = $i AND Zona = $nombre_zona AND tienda = $num_tienda";  
 $result3zq = mysqli_query($connect, $query3zq);
while($row3zq = mysqli_fetch_array($result3zq)) 
	{	
$planilla_c3=$row3zq["planilla"];
}	
if (!empty($planilla_c3))  {
$queryqaaz ="SELECT DISTINCT Planilla FROM fi_conteos 
where Planilla = $planilla_c3 and Bodega = $num_tienda and conteo = $conteo and Estado = 1";	 
$resultqaaz = mysqli_query($connect, $queryqaaz); 
if (mysqli_num_rows($resultqaaz)> 0){?>
...
if (!empty($planilla_c3))  {
$queryqaaz ="SELECT DISTINCT Planilla FROM fi_conteos 
where Planilla = $planilla_c3 and Bodega = $num_tienda and conteo = $conteo and Estado = 2";	 
$resultqaaz = mysqli_query($connect, $queryqaaz); 
if (mysqli_num_rows($resultqaaz)> 0){?>
...
$queryqw ="SELECT * FROM planilla_c3 where zona = $nombre_zona and tienda = $num_tienda"; 
$resultqw = mysqli_query($connect, $queryqw); 
while($rowqw = mysqli_fetch_array($resultqw))  
{
$planillaqw = $rowqw['planilla'];
///////////////////////////////////////	
////////////////////////////////////////////////////////
$queryqw2 ="SELECT DISTINCT Planilla FROM fi_conteos 
where 
Planilla = $planillaqw and Bodega = $num_tienda and conteo = 3";
$resultqw2 = mysqli_query($connect, $queryqw2); 
