 ...
 box-shadow: 0 2px 0 #5e2525, 0px 4px 4px rgba(0,0,0,0.4), inset 0px 2px 5px rgba(0,0,0,0.2);
	  ...
	  <p>&nbsp;</p>
		  <table width="50%" border="0" align="center">
		    <tbody>
		      <tr>
		        <th width="50%" scope="col">Tienda: 
		          <?=$nombre?></th>
		        
		       
		        <th width="50%" scope="col">Usuario: 
		          <?=$usuario?></th>
		      ...
		      <tr>
		        ...
		        <th scope="col"><a class="boton colorBoton formaBoton" href="zonas.php?conteo=2">Auditoria</a></th>
				  <th scope="col"><a class="boton colorBoton formaBoton" href="zonas.php?conteo=1">Conteo</a></th>
	          </tr>
		      <tr>
		        <th scope="col">&nbsp;</th>
		        <th scope="col">&nbsp;</th>
		      ...
		      <tr>
		        <th colspan="2" scope="col" align="center">&nbsp;</th>
	          </tr>
