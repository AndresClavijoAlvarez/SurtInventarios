	...
	var imgDir = "http://web.usbmed.edu.co/empleados/images/"			// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:1px;border-width:5;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:16px}' bgcolor='#ffffff'><tr background='images/calback.jpg'><td background='../images/calback.jpg'><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:16px;'><font color='#a0a0a0'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' BORDER='0' ALT='Close the Calendar'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
