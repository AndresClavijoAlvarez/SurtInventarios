...
echo "WWWWWWWWWWWWWW".$conteo."ooooooooooo".$c_aux;				   
...
<?php 
		...
		for ($i=$rango_inicial; $i<=$rango_final; $i++)	{
					 $queryqa ="SELECT Planilla FROM fi_conteos where Planilla = $i and Bodega = $num_tienda and estado =2 and conteo = $conteo"; 
