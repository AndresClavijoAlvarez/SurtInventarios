      ...
      <thead>  
        <tr>
		  ...
		  <th style="text-align: center" scope="col">Planilla</th>
			<th style="text-align: center" scope="col">Auditoria</th>
			<th style="text-align: center" scope="col">Conteo</th>
...
zonas
WHERE
fi_conteos.Zona = zonas.id_zona and zonas.zona = $zonass and Estado = 2
order by 1";  
...
//////////////////////////////////////////	
echo '<td >'.$conteo2.'</font></h4></td>';	
echo '<td >'.$conteo1.'</font></h4></td>';
