...
Sum(fi_conteos_manual.Cantidad) c2
FROM
fi_conteos_manual
...
$resa1dah = $mysqli->query("delete from planilla_c3 WHERE 	planilla = $Planilla and zona = $zona and tienda = $num_tienda");		
...
FROM
fi_conteos_manual
where planilla = $Planilla and Zona = $idzona and Estado = 2
";  
 $result3 = mysqli_query($connect, $query3);
while($row3 = mysqli_fetch_array($result3)) 
	{	
