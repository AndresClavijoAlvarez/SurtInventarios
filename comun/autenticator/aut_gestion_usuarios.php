...
<table width="500" border="1" cellspacing="0" cellpadding="4" bordercolor="#CCCCCC" align="center">
  ...
  <tr bgcolor="#00CCCC">
    ...
    <div align="center"><font color="#FFFFFF"><a href="$pag?accion=nuevo">Registrar usuario</a></font></div></td>
	 <td width="30%">
      <div align="center"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FFFFFF">Nombre Usuario
        </font></b></div>
    </td>
  </tr>
...
<tr>
	...
	<td width="24%" bgcolor="#FFFFEA"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">$resultados[nombre]</font></div></td>
  </tr>
HTML;
}
echo "</table>";
...
$usuario_consulta = mysql_query("SELECT ID,usuario,nivel_acceso,nombre FROM $sql_tabla WHERE id=$id_mod_nivel") or die("No se pudo realizar la consulta a la Base de datos");
...
<form method="post" action="$PHP_SELF?accion=hacernuevo">
  ...
  <table width="350" border="1" cellspacing="0" cellpadding="4" align="center">
	...
	<tr bgcolor="#FFFFCC">
      <td width="158">
        <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Nombre de Usuario: </font></div>
      </td>
      <td width="170"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
        <input type="text" name="usuario" class="imputbox" size="20" maxlength="20">
        </font></b></td>
    </tr>
    <tr bgcolor="#FFFFCC">
      <td colspan="2" height="40">
...
$pass1 = md5($pass1);
$id = rand(1,9999);
mysql_query("INSERT INTO $sql_tabla values('$id','$usuario','$pass1','$nivel','$usuarionombre')") or die(mysql_error());
mysql_close();
