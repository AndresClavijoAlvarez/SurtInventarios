...
if (isset($_POST["zonas"]))
 ...
 $res = $mysqli->query("insert into zonas (zonas) values ('$zonas')"); 	
...
'
								   ?>
									<td><? echo utf8_encode($row["zonas"]); ?></td>
							  

<?
$id=$row["id_zonas"];
$delete_zonas="<a href='delete_zonas.php?id=$aux_id_get1$id'><img src='images/btn_borrar.png'  width='71' height='30' /></a>\n"; 
?>
<td align="center"><a href="javascript:void(0);" data-toggle="modal" data-target="#modal" onClick="carga_ajax('<? echo $row['id_zonas']; ?>','modal','ajax_Proveedores_act.php');"><a href="javascript:void(0);" data-toggle="modal" data-target="#modal" onClick="carga_ajax('<? echo $row['id_zonas']; ?>','modal','ajax_zonas_act.php');"><img src="images/btn_actualizar.png" width="71" height="30" alt=""/></a></td>
